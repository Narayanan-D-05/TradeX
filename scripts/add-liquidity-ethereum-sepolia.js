...
// Latest Deployed Addresses on Ethereum Sepolia
const LIQUIDITY_MANAGER = "0x6127b25A12AB31dF2B58Fe9DfFCba595AB927eA3";
const POOL_MANAGER = "0xf448192241A9BBECd36371CD1f446de81A5399d2";
...
async function main() {
    console.log("\n🌊 \x1b[35mETHEREUM SEPOLIA V4 LIQUIDITY PROVIDER\x1b[0m 🌊");
    ...
    try {
        ...
        await tx.wait();
        console.log("✅ SUCCESS! Liquidity provisioned on Ethereum Sepolia.");
    } catch (e) {
